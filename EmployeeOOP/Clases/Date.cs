...
namespace EmployeeOOP.Clases
{
    public class Date
    {
        ...
        private int _year;
        private int _month;
        private int _day; //format 06/05/2023
        ...
        {
            //valido si el dia ingresado pertenece a un dia bisiesto
        ...
        {
            //dia/mes/año
            var dateConcatenated1 = _day +"/"+_month +"/"+_year; //la mas vieja y fea(concatenacion)
